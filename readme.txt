...
2. Open the cod+test folder in a terminal.

3. Run the executable file using the command:
...
*Handling function definitions, parameters, and return values
*Understanding recursion at language level
